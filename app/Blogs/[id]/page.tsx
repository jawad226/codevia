...
export default async function BlogDetailsPage({ params }: PageProps) {
  ...
  return (
    <>
      <nav className="bg-white mt-28  sticky top-0 z-50">
      ...
      <section className="min-h-screen  from-[#f6fdfa] via-[#f1f9f7] to-[#e8f6f3] py-12">
        <article className="max-w-4xl mx-auto">
          <header className="text-center mb-12 px-6">
            <div className="flex justify-center gap-4 mb-6">
              <span className="bg-[#c7d2fe] text-[#3730a3] px-4 py-2 rounded-full text-sm font-medium">
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden mx-6">
            <div className="p-8 lg:p-12">
              <div className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-relaxed prose-a:text-teal-600 prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 prose-blockquote:border-teal-600 prose-blockquote:bg-teal-50 prose-blockquote:italic prose-ul:text-gray-700 prose-ol:text-gray-700">
                ...
                <div className="bg-gradient-to-r from-[#c7d2fe] to-blue-50 rounded-2xl p-8 my-12 border border-teal-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {relatedBlogs.map((relatedBlog) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="font-bold text-gray-900 mb-2 group-hover:text-[#3730a3] transition-colors line-clamp-2">
                      {relatedBlog.title}
                    </h3>
        ...
        <section className="max-w-4xl mx-auto mt-20 px-6">
          <div className="bg-gradient-to-r from-[#3730a3] to-blue-600 rounded-3xl p-12 text-center text-white">
