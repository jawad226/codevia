...
export default function BlogsPage() {
  ...
  return (
    <section className="min-h-screen py-24 bg-[#f5f9ff] py-5 px-2 lg:px-24">
      <motion.header
      ...
      >
        <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
          My <span className="text-[#4338ca]">Blog</span> Journey
        </h1>
        ...
        {categories.map((category) => (
          <button
            ...
            className={`px-6 py-3 rounded-full font-medium capitalize transition-all duration-300 ${selectedCategory === category
                ? "bg-[#3730a3] text-white hover:bg-[#312e81] shadow-lg shadow-[#818cf8]"
          ...
          <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden">
            <div className="lg:flex">
              <div className="relative lg:w-1/2 h-80 lg:h-auto">
                ...
                />
                <div className="absolute top-4 left-4 bg-[#3730a3] text-white  px-4 py-2 rounded-full text-sm font-semibold">
                  Featured
                </div>
              </div>
              <div className="lg:w-1/2 p-8 flex flex-col justify-center">
                <div className="flex items-center gap-4 mb-4">
                  <span className="bg-[#c7d2fe] text-[#3730a3] px-3 py-1 rounded-full text-sm font-medium">
                    {blogs[0].category || "Web Development"}
                  </span>
                  <span className="text-gray-500 text-sm">{blogs[0].readTime || "5 min read"}</span>
                </div>
                <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4  transition-colors">
                  {blogs[0].title}
                </h3>
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center bg-[#3730a3] text-white  hover:bg-[#312e81] px-8 py-4 rounded-full font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group"
                >
          ...
          >
            ...
            <div className="p-6 flex-1 flex flex-col">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-sm text-[#3730a3] font-medium">{blog.readTime || "4 min read"}</span>
              </div>

              <h3 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-[#3730a3] transition-colors duration-300">
                {blog.title}
              </h3>
              ...
              <div className="mt-auto pt-4 border-t border-gray-100">
                <Link
                  href={`/Blogs/${blog.id}`}
                  className="inline-flex items-center justify-center w-full bg-[#3730a3] text-white px-6 py-3 rounded-xl font-semibold text-sm shadow-md hover:bg-[#312e81]  hover:shadow-lg transform hover:scale-105 transition-all duration-300 group"
                >
                  Read Full Article
                  <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
                </Link>
